...
export const llmModels: Model[] = [
  ...
  },
  {
    ...
    name: "GPT-5.1",
    type: "llm",
    description: "OpenAI flagship reasoning model (via /api/llm/openai).",
    provider: "openai",
    costPerMinute: 0.01,
    supportsAudio: false,
    supportsText: true,
  },
  {
    ...
    name: "GPT-5.1 Code",
    type: "llm",
    description: "OpenAI code-first preset for structured responses.",
    provider: "openai",
    costPerMinute: 0.011,
    supportsAudio: false,
    supportsText: true,
  },
  {
    ...
    name: "Claude 3.5",
    type: "llm",
    description: "Anthropic conversational model (via /api/llm/anthropic).",
    provider: "anthropic",
    costPerMinute: 0.012,
    supportsAudio: false,
    supportsText: true,
  },
  {
    ...
    name: "Sonnet 4.5",
    type: "llm",
    description: "Anthropic creative tone tuned for longer answers.",
    provider: "anthropic",
    costPerMinute: 0.013,
    supportsAudio: false,
    supportsText: true,
  },
  {
    ...
    name: "Gemini 1.5",
    type: "llm",
    description: "Google Gemini via /api/llm/gemini.",
    provider: "google",
    costPerMinute: 0.009,
    supportsAudio: false,
    supportsText: true,
